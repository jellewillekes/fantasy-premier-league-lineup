...
def get_players_df(boot: dict) -> pd.DataFrame:
    ...
    df = (elements
          ...
          .merge(types, left_on="element_type", right_on="element_type", how="left"))
    ...
    num_cols = [
        "now_cost","total_points","points_per_game","form","minutes","starts","selected_by_percent",
        "expected_goals","expected_assists","expected_goal_involvements","expected_goals_conceded",
        "expected_goals_per_90","expected_assists_per_90","expected_goal_involvements_per_90",
        "expected_goals_conceded_per_90","clean_sheets_per_90","saves_per_90","goals_conceded_per_90","starts_per_90",
    ]
    for c in num_cols:
        if c in df.columns:
